...
Public Class Deposit
    ...
    Private _Deposit As CableSoft.SO.BLL.Order.Deposit.Deposit
    Private result As New RIAResult()
    Public Property isHTML As Boolean = False
    Private Sub InitClass(ByVal LoginInfo As LoginInfo)
        _Deposit = New CableSoft.SO.BLL.Order.Deposit.Deposit(LoginInfo.ConvertTo(LoginInfo))
    End Sub
    Public Function QueryPTCode(ByVal LoginInfo As LoginInfo,
                                ByVal BPCode As String,
                                ByVal CitemCode As Integer) As RIAResult
        Try
            InitClass(LoginInfo)
            Dim dt As DataTable = _Deposit.QueryPTCode(BPCode, CitemCode)
        ...
        Return result
    End Function
    Public Function ChoosePTCode(ByVal LoginInfo As LoginInfo,
                                ByVal BPCode As String,
                                ByVal CitemCode As Integer,
                                ByVal PTCode As Integer) As RIAResult
        Try
            InitClass(LoginInfo)
            Dim dt As DataTable = _Deposit.ChoosePTCode(BPCode, CitemCode, PTCode)
            result.ResultXML = CableSoft.BLL.Utility.JsonServer.ToJson(dt.DataSet, JsonServer.JsonFormatting.None, JsonServer.NullValueHandling.Ignore, True, True, isHTML)
            'result.ResultXML = Silverlight.DataSetConnector.Connector.ToXml(dt.DataSet)
            result.ResultBoolean = True
        Catch ex As Exception
        ...
        Return result
    End Function
    Public Function QueryCMCode(ByVal LoginInfo As LoginInfo) As RIAResult
        Try
            InitClass(LoginInfo)
            Dim dt As DataTable = _Deposit.QueryCMCode()
            result.ResultXML = CableSoft.BLL.Utility.JsonServer.ToJson(dt.DataSet, JsonServer.JsonFormatting.None, JsonServer.NullValueHandling.Ignore, True, True, isHTML)
            'result.ResultXML = Silverlight.DataSetConnector.Connector.ToXml(dt.DataSet)
            result.ResultBoolean = True
        Catch ex As Exception
