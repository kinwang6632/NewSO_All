...
Partial Public Class MainPage
    ...
    Private Sub btnSO1112A_Click(sender As System.Object, e As System.Windows.RoutedEventArgs) Handles btnSO1112A.Click
        ...
        dr.Item("SNO") = "201504MC3205324"
        dr.Item("CustId") = 693320
        dr.Item("CustId") = 675211
    ...
    Private Sub btnDynUpdateGrid_Click(sender As System.Object, e As System.Windows.RoutedEventArgs) Handles btnDynUpdateGrid.Click
        ...
        objControl.EditMode = GetEditModeValue()
        objControl.LoginInfo = FLoginInfo
        objControl.SysProgramId = "SO6790A"
        'objControl.SysProgramId = "SO6190A"
        objControl.IsAutoClosed = False
        ShowChildWindow(objControl, New Size(900, 500))
    End Sub
    ...
    Private Sub btnTextOut_Click(sender As System.Object, e As System.Windows.RoutedEventArgs) Handles btnTextOut.Click
        ...
        objControl.EditMode = GetEditModeValue()
        objControl.LoginInfo = FLoginInfo
        objControl.SysProgramId = "SO3272A"
        'objControl.Parameters = aCollect
        ShowChildWindow(objControl, New Size(900, 500))
    End Sub
    ...
    Private Sub btnSO1100G_Click(sender As System.Object, e As System.Windows.RoutedEventArgs) Handles btnSO1100G.Click
        ...
        Dim dr As Silverlight.DataRow = tb.NewRow
        ''159, "200609190189257"
        'dr.Item("MasterId") = 56807
        'dr.Item("MasterId") = 56585
        dr.Item("CustId") = 600282
        ''dr.Item("FACISEQNO") = "200609190189257"
        'dr.Item("ServiceType") = "I"
        tb.Rows.Add(dr)
        ds.Tables.Add(tb)
    ...
    Private Sub btnVodClose_Click(sender As System.Object, e As System.Windows.RoutedEventArgs) Handles btnVodClose.Click
        ...
        objControl.Parameters = aCollect
        objControl.EditMode = GetEditModeValue()
        ShowChildWindow(objControl, New Size(500, 550))
    End Sub
    ...
    Private Sub btnCredit_Click(sender As System.Object, e As System.Windows.RoutedEventArgs) Handles btnCredit.Click
        Dim aResult As InvokeOperation(Of CableSoft.BLL.Utility.RIAResult) = Nothing
        Dim aRiabbCredit As New Global.TestSilverlight2.Web.QueryTable()

        aResult = aRiabbCredit.bbCredit(Global.CableSoft.SL.Utility.Utility.ConvertTo(FLoginInfo, New LoginInfo), 2,
                                     10072090166, "201001130259700", "168297306372", 30)
        AddHandler aResult.Completed, Sub(s, arg)
                                          If s.Value IsNot Nothing Then
                                              MessageBox.Show("成功")
                                          Else
    ...
    Private Sub btnAPI235_Click(sender As System.Object, e As System.Windows.RoutedEventArgs) Handles btnAPI235.Click
        Dim aResult As InvokeOperation(Of CableSoft.BLL.Utility.RIAResult) = Nothing
        Dim aRiaAPI235 As New Global.TestSilverlight2.Web.QueryTable()

        aResult = aRiaAPI235.API235(Global.CableSoft.SL.Utility.Utility.ConvertTo(FLoginInfo, New LoginInfo), "201502MC3205321")
        AddHandler aResult.Completed, Sub(s, arg)
                                          If s.Value IsNot Nothing Then
                                              MessageBox.Show("成功")
                                          Else
    ...
    Private Sub btnAPI252_Click(sender As System.Object, e As System.Windows.RoutedEventArgs) Handles btnAPI252.Click
        Dim aResult As InvokeOperation(Of CableSoft.BLL.Utility.RIAResult) = Nothing
        Dim aRiaAPI235 As New Global.TestSilverlight2.Web.QueryTable()

        aResult = aRiaAPI235.API252(Global.CableSoft.SL.Utility.Utility.ConvertTo(FLoginInfo, New LoginInfo))
        AddHandler aResult.Completed, Sub(s, arg)
                                          If s.Value IsNot Nothing Then
                                              MessageBox.Show("成功")
                                          Else
